/**
 * Module: features/profile/components/sections/ProfileActivitySection.jsx
 * Purpose: Presents the Profile Activity Section UI fragment so parent files can stay focused on flow and data.
 */
